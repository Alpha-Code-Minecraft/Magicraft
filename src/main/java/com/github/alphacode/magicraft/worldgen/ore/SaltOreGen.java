...
public class SaltOreGen implements IWorldGenerator {

    private final WorldGenMinable WorldGenMinable;


    public SaltOreGen(WorldGenMinable WorldGenMinable)
    {
        this.WorldGenMinable =new WorldGenMinable(BlocksRegister.SALT_ORE.getDefaultState(), 5);
    }
